...
def register_parser(parent_subparsers):
    parser = parent_subparsers.add_parser("vignettes", help="VIGNETTE: create png version of channel+nuclei for annotation tool")
    parser.add_argument('path', type=Path, help="the path to the dataset")
    parser.add_argument('--channel_nuclei', type=int, required=True, help="the index of the nuclei (often, 0 or 3, first or last)")
    parser.add_argument('--channel_centrioles', type=int, required=True, nargs='+', help="the index of the channels")
